...
class Kategori_berita_model extends CI_Model {
	...
	//untuk menampilkan semua isi dari tabel kategori_berita
	public function listing(){
		$query = $this->db->get('kategori_berita');
		return $query->result();
	}

	//untuk menampilkan detail satu elemen
	...
	//menambahkan data ke dalam tabel dengan membawa "$data" yang berasal dari controller
