                ...
                <li>
                  <div class="user-box">
                    ...
                    <div class="u-text">
                      ...
                      <p class="text-muted"><?php echo $user_aktif->email ?></p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                    </div>
                  </li>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#"><i class="la la-user"></i> My Profile</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#"><i class="la la-edit"></i> Account Setting</a>
                  <div class="dropdown-divider"></div>
