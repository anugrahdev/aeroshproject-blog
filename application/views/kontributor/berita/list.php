...
//cetak notifikasi
    ...
    # code...
							...
							<a href="<?php echo base_url('kontributor/berita/tambah') ?>" class="btn btn-info" >Tambah <i class="
       la la-plus"></i></a>
       <br><br>
									...
									<tbody>
										...
										foreach ($berita as $berita) {
											...
											<tr>
												...
												<td width="90px">
													<a href="<?php echo base_url('kontributor/berita/edit/'.$berita->id_berita) ?>" class="btn btn-warning btn-sm"><i class="la la-edit"></i></a>
